'''Что-то страшное, собранное и переписанное из статьи на хабре и кода преподавателя
Задумываться об эффективности алгоритма даже нет смысла...
"Здоровья погибшим, земля железобетоном" (с) Владислав Головин
Автор этого монстра - Ганиев Андрей
Все права не защищены, так как их нет
Убейте уже работу, желательно под фонк'''
